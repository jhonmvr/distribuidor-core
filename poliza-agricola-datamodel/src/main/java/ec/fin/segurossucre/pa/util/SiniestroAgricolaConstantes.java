 ...
 *
 */
public class SiniestroAgricolaConstantes {
	...
	public final static String SINIESTRO_AGRICOLA_CONF_DIR = "/portalservicios_dir/siniestro_agricola/";
	 ...
	 * SINIESTROS
	 */
	public static final String RAMO_ID = "13";
	public static final String CODIGO_SINIESTRO_PREFIX = "AG-SN-";
	public static final String NOTIFICACION_SINIESTRO_PREFIX = "UA-NG-";
	public static final Long CODIGO_CANAL_MAGAP = (long) 1;
	public static final BigDecimal VALOR_RESERVA_DEFAULT = BigDecimal.valueOf(500);
	public static final String CODIGO_COSECHA_PREFIX = "AG-CO-";
	public static final String NOTIFICACION_EMAIL = "notificaciones@segurossucre.fin.ec";

	/**
	 * BPMS
	 DESARROLLO public static final String BPMS_PROJECT_VERSION = "1.0.75";
	 PREPRODUCCION public static final String BPMS_PROJECT_VERSION = "1.0.68";
	 // DESARROLLO
	
	 * public static final String API_URL_RESOURCES
	 * ="http://172.16.150.86:8080/siniestro-agricola-rest/resources/"; public
	 * static final String API_URL_ROOT =
	 * "http://172.16.150.86:8080/siniestro-agricola-rest/"; public static final
	 * String API_URL_SERVICE = "https://srvpreprodpw.segurossucre.fin.ec:9888/";
	 * public static final String API_URL_TOKEN = API_URL_SERVICE +"token/"; public
	 * static final String BPMS_URL_SERVICE = "http://172.16.101.60:8280/";
	 ...
	 * public static final String API_URL_RESOURCES
	 * ="http://172.16.150.25:8888/siniestro-agricola-rest/resources/"; public
	 * static final String API_URL_ROOT =
	 * "http://172.16.150.25:8888/siniestro-agricola-rest/"; public static final
	 * String API_URL_SERVICE = "https://srvservicedmz1.segurossucre.fin.ec:9888/";
	 * public static final String API_URL_TOKEN = API_URL_SERVICE +"token/"; public
	 * static final String BPMS_URL_SERVICE = "http://172.16.150.25:9288/";
	 * 
	 */
	public static final String BPMS_PROJECT = "SINIESTRO-AGRICOLA";	
	public static final String BPMS_PROJECT_VERSION = "1.0.1";
	public static final String BPMS_PROJECT_MAIN_BPM = "SINIESTRO-AGRICOLA.modeloFuncionalSiniestroAgricola";
	public static final String BPMS_PROJECT_MAIN_BPM_VERSION = "1.0";
	public static final String BPMS_REST_DEFAULT_CHARSET = "utf-8";
	public static final String BPMS_DEFAULT_USER = "ejecutivoInterno";
	public static final String ICORE_API_RESERVA_VERSION = "1.0";


	public static final Integer BPMS_REST_TIMEOUT_DEFAULT = 60000;

	public static final String MESSAGE_RESERVA_XML = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tem=\"http://tempuri.org/\" xmlns:ssuc=\"ssucrel_Preproduccion3Actual\">\r\n"
			+ "   <soapenv:Header/>\r\n" + "   <soapenv:Body>\r\n" + "      <tem:SucreSiniestrosAperturas.Execute>\r\n"
			+ "         <tem:Sdt_sucresiniestrosaperturas>\r\n" + "            <ssuc:SDT_SucreSiniestrosAperturas>\r\n"
			+ "               <ssuc:SininfgRamo>--ramoid--</ssuc:SininfgRamo>\r\n"
			+ "               <ssuc:PolizaNum>--codidoPoliza--</ssuc:PolizaNum>\r\n"
			+ "               <ssuc:PolizaCertificado>---anx--</ssuc:PolizaCertificado>\r\n"
			+ "               <ssuc:PolizaItemID>1</ssuc:PolizaItemID>\r\n"
			+ "               <ssuc:PolizaItemCodOperacion>1</ssuc:PolizaItemCodOperacion>\r\n"
			+ "               <ssuc:SinepiIndTotPar>P</ssuc:SinepiIndTotPar>\r\n"
			+ "               <ssuc:SininfgLugSnt>--lugarSiniestro--</ssuc:SininfgLugSnt>\r\n"
			+ "               <ssuc:SinepiDes>--observacion--</ssuc:SinepiDes>\r\n"
			+ "               <ssuc:SinepiNotifica>--personaNotifica--</ssuc:SinepiNotifica>\r\n"
			+ "               <ssuc:SinepiFchPre>--fechaAvisoSiniestro--</ssuc:SinepiFchPre>\r\n"
			+ "               <ssuc:SinepiFchOcu>--fechaOcurrencia--</ssuc:SinepiFchOcu>\r\n"
			+ "               <ssuc:SinresValor>--valorReserva--</ssuc:SinresValor>\r\n"
			+ "            </ssuc:SDT_SucreSiniestrosAperturas>\r\n"
			+ "         </tem:Sdt_sucresiniestrosaperturas>\r\n" + "      </tem:SucreSiniestrosAperturas.Execute>\r\n"
			+ "   </soapenv:Body>\r\n" + "</soapenv:Envelope>";
	...
	// WEB_SOCKET_CLIENT_RESERVA="ws://172.16.150.86:8080/siniestro-agricola-rest/siniestrows/";
	 */
	// 
	...
	public static final String CODIGO_POLIZA ="AG-SS-";
	public static final String SOLICITUD_POLIZA = "SOLICITUD_POLIZA";
	public static final String SOLICITUD = "SOLICITUD";
	public static final String FORMATO_SOLICITUD = "FORMATO_SOLICITUD";
	public static final String SEGUROS_SUCRE = "SEGUROS SUCRE S.A.";
	public static final String API_URL_UN01 = "API_URL_UN01";
	public static final String STORAGE_PATH = "STORAGE_PATH";
	public static final String MIN_LATITUD = "MIN_LATITUD";
	public static final String MAX_LATITUD = "MAX_LATITUD";
	public static final String MIN_LONGITUD = "MIN_LONGITUD";
	public static final String MAX_LONGITUD = "MAX_LONGITUD";
	SiniestroAgricolaConstantes() {
