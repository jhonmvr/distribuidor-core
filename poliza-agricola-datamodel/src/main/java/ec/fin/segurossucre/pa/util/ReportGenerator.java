...
public class ReportGenerator {
    ...
    public ByteArrayOutputStream generateReportWithListDatasource() throws SegSucreException{
        try {
            //log.info( "====================> INGRESA A generateReportWithDbConnection CON conexion  " + this.geDB );
            try {
                ...
                throw new SegSucreException(Constantes.ERROR_CODE_CUSTOM, "====>ERROR EN LA GENERACION DEL REPORTE  " +e.getMessage());
            }
           
        } catch (Exception ex) {
        	log.info("====>ERROR EN LA GENERACION DEL REPORTE  " + ex.getMessage());
            throw new SegSucreException(Constantes.ERROR_CODE_CUSTOM, "====>ERROR EN LA GENERACION DEL REPORTE  " + ex.getMessage());
        }
    }
    
    public ByteArrayOutputStream generateReportWithListExcelDatasource() throws SegSucreException{
        try {
            //log.info( "====================> INGRESA A generateReportWithDbConnection CON conexion  " + this.geDB );
            try {
            	 ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public ByteArrayOutputStream generateReportWithJSONDatasource() throws SegSucreException{
        try {
            //log.info( "====================> INGRESA A generateReportWithDbConnection CON conexion  " + this.geDB );
            try {
    ...
    public ByteArrayOutputStream generateReportWithJSONDatasourceExcel() throws SegSucreException{
        try {
            //log.info( "====================> INGRESA A generateReportWithDbConnection CON conexion  " + this.geDB );
            try {
            	ByteArrayInputStream jsonDataStream = new ByteArrayInputStream(this.jsonObj.getBytes());
    ...
    public static byte[] generateReportPdf( List dataSource, String reportFilePath,  Map<String, Object> parameters ) throws SegSucreException{
	 ...
	 public ByteArrayOutputStream generateReportExcelWithListDatasource() throws SegSucreException{
	        try {
	              try {
	            	JasperPrint jasperPrint =null;
	            	 ByteArrayOutputStream baos = new ByteArrayOutputStream();
	 ...
	 public ByteArrayOutputStream generateReportCSVWithListDatasource() throws SegSucreException{
	        try {
	            //log.info( "====================> INGRESA A generateReportWithDbConnection CON conexion  " + this.geDB );
	            try {
	            	 ByteArrayOutputStream baos = new ByteArrayOutputStream();
