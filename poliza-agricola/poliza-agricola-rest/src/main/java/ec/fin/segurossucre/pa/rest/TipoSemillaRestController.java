...
public class TipoSemillaRestController extends BaseRestController implements CrudRestControllerInterface<Tiposemilla, GenericWrapper<Tiposemilla>> {
	...
	public TipoSemillaRestController() throws SegSucreException {
		super();
	}
	...
	public GenericWrapper<Tiposemilla> getEntity(
			@QueryParam("tiposemillaid") String tiposemillaid) throws SegSucreException {
	...
	private PaginatedListWrapper<Tiposemilla> findAll(PaginatedWrapper pw) throws SegSucreException {
	...
	@Override
	public GenericWrapper<Tiposemilla> persistEntity(GenericWrapper<Tiposemilla> arg0) throws SegSucreException {
		// no persisted
		return null;
	}
