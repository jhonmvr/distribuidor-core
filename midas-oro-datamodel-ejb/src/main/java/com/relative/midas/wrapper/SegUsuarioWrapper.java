...
import com.relative.midas.enums.EstadoEnum;
...
public class SegUsuarioWrapper implements Serializable {
	...
	private SegAgenciaWrapper segAgencia;
	...
	public SegAgenciaWrapper getSegAgencia() {
		return segAgencia;
	}

	public void setSegAgencia(SegAgenciaWrapper segAgencia) {
	...
	public String toJSON() {
		...
		r.append("\"segAgencia\":").append(this.segAgencia).append(",");
