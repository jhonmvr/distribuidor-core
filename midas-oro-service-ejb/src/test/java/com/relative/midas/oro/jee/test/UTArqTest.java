...
public class UTArqTest {
	...
	private static JavaArchive generateDataModel() {
		...
		try {
			ejbDependenciesDm = Maven.resolver()
					.loadPomFromFile("../midas-oro-datamodel-ejb/pom.xml")
	    ...
	    JavaArchive ejbDataModel = ShrinkWrap.create(JavaArchive.class, "midas-oro-datamodel-ejb.jar")	    		
	    		.addPackage("com.relative.sa.model")
	    		.addPackage("com.relative.sa.enums")
	    		.addPackage("com.relative.sa.util")
	    		.addPackage("com.relative.sa.wrapper")
	...
	private static JavaArchive generateRepository() {
		...
		try {
			ejbDependenciesRepo= Maven.resolver()
					.loadPomFromFile("../midas-oro-repository-ejb/pom.xml")
					.importDependencies(ScopeType.COMPILE, ScopeType.TEST)
					.resolve()
					.withTransitivity()
					.asFile();
	    ...
	    JavaArchive ejbRepository = ShrinkWrap.create(JavaArchive.class, "midas-oro-repository-ejb.jar")	    		
	    		.addPackage("com.relative.sa.repository")
	    		.addPackage("com.relative.sa.repository.imp")
	    		.addPackage("com.relative.sa.repository.spec")
	    		.addAsManifestResource(EmptyAsset.INSTANCE, "beans.xml");
	...
	private static JavaArchive generateService() {
		File[] ejbDependenciesServ = Maven.resolver()
	    		...
	    		.withTransitivity()
	    		.asFile();
	    JavaArchive ejbServ = ShrinkWrap.create(JavaArchive.class, "midas-oro-service-ejb.jar")	  
	    		.addPackage("com.relative.sa.cdi")
	    		.addPackage("com.relative.sa.service")
	    		//.addPackage("com.relative.sa.jee.test")
    ...
    public static Archive<?> createTestArchive() {
		...
		EnterpriseArchive ear = ShrinkWrap
	    		.create(EnterpriseArchive.class, "midas-oro-ear.ear"); 
